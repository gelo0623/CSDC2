    ...
    while (true) {
        ...
        // REMOVE ITEM
            ...
            while (true) {
                ...
                cout << "============ RECEIPT ============" << endl;
                for (int i = 0; i < receiptItems.size(); i++) {
                    cout << i << " - " << receiptItems[i] << " x" << receiptQuantities[i] << " = Php" << receiptPrices[i] * receiptQuantities[i] << endl;
                    total += receiptPrices[i] * receiptQuantities[i];
                }
                ...
                if (receiptChoice == 1) {
                    ...
                    if (removeQuantity > receiptQuantities[remo]) {
                        cout << "Cannot remove more than quantity" << endl;
                        continue;
                    }
                    
                    receiptQuantities[remo] -= removeQuantity; // hehe nakuha ko na sir
                    if (receiptQuantities[remo] == 0) {
