...
private:
    ...
    void runTimer(Song s) {
        ...
        cout << "\n  Press SPACE to pause/RESUME. Any other key to stop...\n\n";
...
void choosePlay () {
    ...
    cout << "========== SELECT A SONG TO PLAY ==========" << endl;
    ...
    do {
        cout << count++ << ". " << tm->song.title << " - " << tm->song.artist << "\n";
        tm = tm->next;
...
void menu() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 8: player.choosePlay(); break;
            case 0:
                clearScreen();
